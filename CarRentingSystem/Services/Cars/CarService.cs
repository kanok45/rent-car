namespace CarRentingSystem.Services.Cars
{
    ...
    public class CarService : ICarService
    {
        ...
        public int Create(string brand, string model, string description, string imageUrl, int year, int categoryId, int dealerId, decimal pricePerDay)
        {
            var carData = new Car
            {
                Brand = brand,
            ...
            decimal pricePerDay)
        {
            ...
            carData.PricePerDay = pricePerDay;
